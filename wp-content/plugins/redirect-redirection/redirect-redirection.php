...
define("IRRP_PLUGIN_VERSION", "1.1.3");
...
add_action('plugins_loaded', function () {
    ...
    if (!(class_exists('\Inisev\Subs\InisevBlackFriday') || class_exists('Inisev\Subs\InisevBlackFriday') || class_exists('InisevBlackFriday'))) {
      require_once IRRP_DIR_PATH . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'blackfriday2022' . DIRECTORY_SEPARATOR . 'bf.php';
    }
    $blackfriday_banner = new \Inisev\Subs\InisevBlackFriday('redirect-redirection', 'Redirect Redirection', 'http://bit.ly/3XkedK2', ['admin.php?page=irrp-redirection']);
